...
const Toolbar = () => {
    ...
    const boundingBoxRect = useMemo(() => {
        ...
        return boundingRect(controlBox.boxSize, controlBox.position, controlBox.rotate);
    }, [controlBox]);
    ...
    const showContextMenu = () => {
        if (isOpenMenu) {
            ...
            actions.showContextMenu({ clientX: rect.right - 42, clientY: rect.bottom + 4 });
        }
    };
                    ...
                    {(isLocked || isPageLocked) && (
                        <div
                            css={{
                                ...
                                ':hover': {
                                    backgroundColor: isPageLocked ? undefined : 'rgba(64,87,109,.07)',
                                },
                            }}
                            onClick={() => {
