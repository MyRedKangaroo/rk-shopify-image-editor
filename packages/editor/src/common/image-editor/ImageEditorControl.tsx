...
import { BoxData, getTransformStyle } from '@lidojs/core';
import { ImageEditorData } from '@lidojs/editor';
...
const ImageEditorControl: FC = () => {
    ...
    const { imageEditor, actions, originalLayer, scale } = useEditor((state) => {
